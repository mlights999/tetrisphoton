...
bool movePiece(int* currSpot, int direction, int pid, int orientation, int pieceColor, int * userScore, int * currLevel, int* userBoard);
...
#line 27 "c:/Users/mligh/OneDrive/Particle/TetrisPhoton/tetrisphoton/src/tetrisphoton.ino"
